...
A growing line of work studies the ability of transformer-based agents to learn new tasks from context without weight updates. Algorithm Distillation~\citep{laskin2022incontext} trains transformers on learning histories so that they can improve in-context. \citet{lee2024supervised} show that supervised pretraining on diverse tasks enables in-context RL. Prompt-DT~\citep{xu2022prompting} uses trajectory demonstrations as prompts for few-shot policy generalization. These works demonstrate that transformers can extract task-relevant information from their context window. \cspo{} builds on this insight but takes a different approach: rather than training models to be better in-context learners, we optimize what context is provided to an already-trained model.
...
\begin{table}[t]
\centering
\caption{\textbf{D4RL normalized scores} on MuJoCo locomotion tasks. All methods use the same offline datasets. \cspo{} operates on a frozen DT with no gradient updates. Bold indicates best, underline indicates second best. Scores are averaged over 100 evaluation episodes with 3 random seeds.}
\label{tab:main_results}
\vspace{0.5em}
\small
\begin{tabular}{l c c c c c c c}
\toprule
\textbf{Environment} & \bc{} & \cql{} & \iql{} & \dt{} & DT+FT & Diffuser & \cspo{} \\
\midrule
halfcheetah-m & 42.6 & 44.0 & 47.4 & 42.6 & 46.2 & 44.2 & \textbf{48.1} \\
hopper-m & 52.9 & 58.5 & 66.3 & 67.6 & 71.2 & \underline{74.3} & \textbf{76.8} \\
walker2d-m & 75.3 & 72.5 & 78.3 & 74.0 & 79.1 & \underline{79.6} & \textbf{82.4} \\
\midrule
halfcheetah-m-r & 36.6 & 45.5 & 44.2 & 36.6 & 42.8 & 37.7 & \textbf{46.3} \\
hopper-m-r & 18.1 & 48.6 & 63.5 & 82.7 & 86.4 & \textbf{96.8} & \underline{94.2} \\
walker2d-m-r & 26.0 & \underline{77.2} & 73.9 & 66.6 & 74.5 & 70.6 & \textbf{79.8} \\
\midrule
halfcheetah-m-e & 55.2 & 91.6 & 86.7 & 86.8 & 90.3 & 88.9 & \textbf{93.7} \\
hopper-m-e & 52.5 & \underline{105.4} & 91.5 & 107.6 & 110.2 & 103.3 & \textbf{111.8} \\
walker2d-m-e & 107.5 & 108.8 & 109.6 & 108.1 & \underline{110.7} & 106.9 & \textbf{112.4} \\
\midrule
\textbf{Average} & 51.9 & 72.5 & 73.5 & 74.7 & \underline{79.0} & 78.0 & \textbf{82.8} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{\textbf{Per-seed D4RL normalized scores for \cspo{}.} Three seeds; mean $\pm$ std reported.}
\label{tab:per_seed}
\vspace{0.5em}
\small
\begin{tabular}{l c c c c}
\toprule
\textbf{Environment} & \textbf{Seed 1} & \textbf{Seed 2} & \textbf{Seed 3} & \textbf{Mean $\pm$ Std} \\
\midrule
halfcheetah-m & 47.8 & 48.4 & 48.0 & 48.1 $\pm$ 0.3 \\
hopper-m & 75.6 & 77.9 & 76.8 & 76.8 $\pm$ 1.2 \\
walker2d-m & 81.9 & 83.1 & 82.3 & 82.4 $\pm$ 0.6 \\
halfcheetah-m-r & 45.8 & 46.7 & 46.4 & 46.3 $\pm$ 0.5 \\
hopper-m-r & 93.1 & 95.4 & 94.0 & 94.2 $\pm$ 1.2 \\
walker2d-m-r & 79.2 & 80.5 & 79.6 & 79.8 $\pm$ 0.7 \\
halfcheetah-m-e & 93.2 & 94.1 & 93.8 & 93.7 $\pm$ 0.5 \\
hopper-m-e & 111.0 & 112.5 & 111.8 & 111.8 $\pm$ 0.8 \\
walker2d-m-e & 112.0 & 112.9 & 112.2 & 112.4 $\pm$ 0.5 \\
\bottomrule
\end{tabular}
\end{table}
